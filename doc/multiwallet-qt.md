...
In order to support loading of multiple wallets in aureusxiv-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aureusxiv.cpp.
...
Changes to aureusxiv.cpp
----------------------
aureusxiv.cpp is the entry point into aureusxiv-qt, and as such, will require some minor modifications to provide hooks for
