...
In order to support loading of multiple wallets in AXIV-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is AXIV.cpp.
...
Changes to AXIV.cpp
----------------------
AXIV.cpp is the entry point into AXIV-qt, and as such, will require some minor modifications to provide hooks for
