...
#   c) node1 mines 32 blocks, so now node 0 has 60001AXIV, node 1 has 4250AXIV, node2 has none.
#   d) node0 sends 601 AureusXIV to node2, in two transactions (301 AureusXIV, then 300 AureusXIV).
