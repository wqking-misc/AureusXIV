...
bool CheckBlockSignature(const CBlock& block)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either zAXIV or normal UTXO
     *  zAXIV: Each zAXIV has a keypair associated with it. The serial number is a hash of the public key.
