...
// VITAE: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_23_DISABLE_NEW_FUNDAMENTALNODE) r = SPORK_23_DISABLE_NEW_FUNDAMENTALNODE_DEFAULT;
        if (nSporkID == SPORK_24_MASTERNODE_SCANNING) r = SPORK_24_MASTERNODE_SCANNING_DEFAULT;
        if (nSporkID == SPORK_25_MASTERNODE_PAYMENTS_ENFORCEMENT) r = SPORK_25_MASTERNODE_PAYMENTS_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_23_DISABLE_NEW_FUNDAMENTALNODE") return SPORK_23_DISABLE_NEW_FUNDAMENTALNODE;
    if (strName == "SPORK_24_MASTERNODE_SCANNING") return SPORK_24_MASTERNODE_SCANNING;
    if (strName == "SPORK_25_MASTERNODE_PAYMENTS_ENFORCEMENT") return SPORK_25_MASTERNODE_PAYMENTS_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_23_DISABLE_NEW_FUNDAMENTALNODE) return "SPORK_23_DISABLE_NEW_FUNDAMENTALNODE";
    if (id == SPORK_24_MASTERNODE_SCANNING) return "SPORK_24_MASTERNODE_SCANNING";
    if (id == SPORK_25_MASTERNODE_PAYMENTS_ENFORCEMENT) return "SPORK_25_MASTERNODE_PAYMENTS_ENFORCEMENT";
