...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_23_MASTERNODE_PAYMENT_ENFORCEMENT) r = SPORK_23_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_23_MASTERNODE_PAYMENT_ENFORCEMENT") return SPORK_23_MASTERNODE_PAYMENT_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_23_MASTERNODE_PAYMENT_ENFORCEMENT) return "SPORK_23_MASTERNODE_PAYMENT_ENFORCEMENT";
