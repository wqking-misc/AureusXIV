...
std::vector<CSporkDef> sporkDefs = {
        ...
        MAKE_SPORK_DEF(SPORK_8_FUNDAMENTALNODE_PAYMENT_ENFORCEMENT, 4070908800ULL), // OFF
        MAKE_SPORK_DEF(SPORK_9_MASTERNODE_PAYMENT_ENFORCEMENT,      4070908800ULL), // OFF
        MAKE_SPORK_DEF(SPORK_10_FUNDAMENTALNODE_BUDGET_ENFORCEMENT, 4070908800ULL), // OFF
        MAKE_SPORK_DEF(SPORK_11_ENABLE_SUPERBLOCKS,                 4070908800ULL), // OFF
        MAKE_SPORK_DEF(SPORK_12_NEW_PROTOCOL_ENFORCEMENT,           4070908800ULL), // OFF
        MAKE_SPORK_DEF(SPORK_13_NEW_PROTOCOL_ENFORCEMENT_2,         4070908800ULL), // OFF
        MAKE_SPORK_DEF(SPORK_14_DISABLE_NEW_FUNDAMENTALNODE,         0), // OFF
};
...
{
    return CPubKey(ParseHex(Params().strSporkPubKey()));
}

const CPubKey CSporkMessage::GetPublicKeyOld() const
{
    return CPubKey(ParseHex(Params().SporkKeyOld()));
}
