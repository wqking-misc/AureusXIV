...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1618597216, 750685, 0x1e0ffff0, 1, 250 * COIN);
        
        const uint256 checkHash("000002a99dbe97c85cf2c59e6d39ae66732ba367b54f52a6f1115ef7515c9688");
