/* src/config/aureusxiv-config.h.  Generated from aureusxiv-config.h.in by configure.  */
/* src/config/aureusxiv-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AUREUSXIV_CONFIG_H

#define AUREUSXIV_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.aureusxivtoken.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AureusXIV Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AureusXIV Core 4.5.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aureusxiv"
