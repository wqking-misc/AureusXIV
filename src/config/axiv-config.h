/* src/config/axiv-config.h.  Generated from axiv-config.h.in by configure.  */
/* src/config/vitae-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AXIV_CONFIG_H

#define AXIV_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.axivtoken.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Axiv Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Axiv Core 4.5.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "axiv"
