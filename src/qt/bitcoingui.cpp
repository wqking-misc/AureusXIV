...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VITAE addresses"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vitae: URIs)"));
    ...
    privacyAction = new QAction(QIcon(":/icons/send"), tr("&Privacy"), this);
    privacyAction->setStatusTip(tr("Privacy Actions for zVITAE"));
    privacyAction->setToolTip(privacyAction->statusTip());
    privacyAction->setCheckable(true);
    privacyAction->setFont(GUIUtil::primaryFont());
#ifdef Q_OS_MAC
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VITAE Core"), this);
    aboutAction->setStatusTip(tr("Show information about VITAE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VITAE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VITAE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VITAE addresses"));
    ...
    openAction->setStatusTip(tr("Open a VITAE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VITAE Core help message to get a list with possible VITAE command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VITAE network", "", count));
}
