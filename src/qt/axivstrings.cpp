...
QT_TRANSLATE_NOOP("AXIV-core", "(must be 101335 for mainnet)"),
...
QT_TRANSLATE_NOOP("AXIV-core", "Accept public REST requests (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Acceptable ciphers (default: %s)"),
QT_TRANSLATE_NOOP("AXIV-core", "Add a node to connect to and attempt to keep the connection open"),
QT_TRANSLATE_NOOP("AXIV-core", "Allow DNS lookups for -addnode, -seednode and -connect"),
QT_TRANSLATE_NOOP("AXIV-core", "Already have that input."),
QT_TRANSLATE_NOOP("AXIV-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Attempt to force blockchain corruption recovery"),
QT_TRANSLATE_NOOP("AXIV-core", "Attempt to recover private keys from a corrupt wallet.dat"),
QT_TRANSLATE_NOOP("AXIV-core", "Automatically create Tor hidden service (default: %d)"),
...
QT_TRANSLATE_NOOP("AXIV-core", "Cannot resolve -externalip address: '%s'"),
QT_TRANSLATE_NOOP("AXIV-core", "Cannot resolve -whitebind address: '%s'"),
QT_TRANSLATE_NOOP("AXIV-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("AXIV-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("AXIV-core", "Connect only to the specified node(s)"),
QT_TRANSLATE_NOOP("AXIV-core", "Connect through SOCKS5 proxy"),
QT_TRANSLATE_NOOP("AXIV-core", "Connect to a node to retrieve peer addresses, and disconnect"),
...
QT_TRANSLATE_NOOP("AXIV-core", "Disable safemode, override a real safe mode event (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Discover own IP address (default: 1 when listening and no -externalip)"),
QT_TRANSLATE_NOOP("AXIV-core", "Display the stake modifier calculations in the debug.log file."),
QT_TRANSLATE_NOOP("AXIV-core", "Display verbose coin stake messages in the debug.log file."),
QT_TRANSLATE_NOOP("AXIV-core", "Do not load the wallet and disable wallet RPC calls"),
QT_TRANSLATE_NOOP("AXIV-core", "Do you want to rebuild the block database now?"),
QT_TRANSLATE_NOOP("AXIV-core", "Done loading"),
QT_TRANSLATE_NOOP("AXIV-core", "Enable automatic Zerocoin minting (0-1, default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("AXIV-core", "Enable publish hash transaction (locked via SwiftX) in <address>"),
QT_TRANSLATE_NOOP("AXIV-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("AXIV-core", "Enable publish raw block in <address>"),
...
QT_TRANSLATE_NOOP("AXIV-core", "Error"),
QT_TRANSLATE_NOOP("AXIV-core", "Error: A fatal internal error occured, see debug.log for details"),
QT_TRANSLATE_NOOP("AXIV-core", "Error: Can't select current denominated inputs"),
QT_TRANSLATE_NOOP("AXIV-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("AXIV-core", "Error: Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("AXIV-core", "Error: Wallet locked, unable to create transaction!"),
QT_TRANSLATE_NOOP("AXIV-core", "Error: You already have pending entries in the Obfuscation pool"),
QT_TRANSLATE_NOOP("AXIV-core", "Failed to calculate accumulator checkpoint"),
QT_TRANSLATE_NOOP("AXIV-core", "Failed to listen on any port. Use -listen=0 if you want this."),
...
QT_TRANSLATE_NOOP("AXIV-core", "Found enough users, signing ..."),
QT_TRANSLATE_NOOP("AXIV-core", "Generate coins (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("AXIV-core", "If <category> is not supplied, output all debugging information."),
QT_TRANSLATE_NOOP("AXIV-core", "Importing..."),
QT_TRANSLATE_NOOP("AXIV-core", "Imports blocks from external blk000??.dat file"),
QT_TRANSLATE_NOOP("AXIV-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Incompatible mode."),
...
QT_TRANSLATE_NOOP("AXIV-core", "Insufficient funds."),
QT_TRANSLATE_NOOP("AXIV-core", "Invalid -onion address or hostname: '%s'"),
QT_TRANSLATE_NOOP("AXIV-core", "Invalid -proxy address or hostname: '%s'"),
QT_TRANSLATE_NOOP("AXIV-core", "Invalid amount for -maxtxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("AXIV-core", "Invalid amount for -minrelaytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("AXIV-core", "Invalid amount for -mintxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("AXIV-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
...
QT_TRANSLATE_NOOP("AXIV-core", "Last Obfuscation was too recent."),
QT_TRANSLATE_NOOP("AXIV-core", "Last successful Obfuscation action was too recent."),
QT_TRANSLATE_NOOP("AXIV-core", "Limit size of signature cache to <n> entries (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Line: %d"),
QT_TRANSLATE_NOOP("AXIV-core", "Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Listen for connections on <port> (default: %u or testnet: %u)"),
...
QT_TRANSLATE_NOOP("AXIV-core", "Obfuscation request incomplete:"),
QT_TRANSLATE_NOOP("AXIV-core", "Only accept block chain matching built-in checkpoints (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
QT_TRANSLATE_NOOP("AXIV-core", "Options:"),
QT_TRANSLATE_NOOP("AXIV-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("AXIV-core", "Percentage of automatically minted Zerocoin  (10-100, default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Preparing for resync..."),
QT_TRANSLATE_NOOP("AXIV-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Print version and exit"),
QT_TRANSLATE_NOOP("AXIV-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("AXIV-core", "RPC server options:"),
QT_TRANSLATE_NOOP("AXIV-core", "RPC support for HTTP persistent connections (default: %d)"),
QT_TRANSLATE_NOOP("AXIV-core", "Randomly drop 1 of every <n> network messages"),
QT_TRANSLATE_NOOP("AXIV-core", "Randomly fuzz 1 of every <n> network messages"),
QT_TRANSLATE_NOOP("AXIV-core", "Rebuild block chain index from current blk000??.dat files"),
QT_TRANSLATE_NOOP("AXIV-core", "Recalculating coin supply may take 30-60 minutes..."),
QT_TRANSLATE_NOOP("AXIV-core", "Recalculating supply statistics may take 30-60 minutes..."),
QT_TRANSLATE_NOOP("AXIV-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Reindex the accumulator database"),
QT_TRANSLATE_NOOP("AXIV-core", "Relay and mine data carrier transactions (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Rescan the block chain for missing wallet transactions"),
QT_TRANSLATE_NOOP("AXIV-core", "Rescanning..."),
QT_TRANSLATE_NOOP("AXIV-core", "ResetMintZerocoin finished: "),
QT_TRANSLATE_NOOP("AXIV-core", "ResetSpentZerocoin finished: "),
QT_TRANSLATE_NOOP("AXIV-core", "Run a thread to flush wallet periodically (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Run in the background as a daemon and accept commands"),
QT_TRANSLATE_NOOP("AXIV-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Server certificate file (default: %s)"),
QT_TRANSLATE_NOOP("AXIV-core", "Server private key (default: %s)"),
...
QT_TRANSLATE_NOOP("AXIV-core", "Shrink debug.log file on client startup (default: 1 when no -debug)"),
QT_TRANSLATE_NOOP("AXIV-core", "Signing failed."),
QT_TRANSLATE_NOOP("AXIV-core", "Signing timed out."),
QT_TRANSLATE_NOOP("AXIV-core", "Signing transaction failed"),
...
QT_TRANSLATE_NOOP("AXIV-core", "Transaction amount too small"),
QT_TRANSLATE_NOOP("AXIV-core", "Transaction amounts must be positive"),
QT_TRANSLATE_NOOP("AXIV-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("AXIV-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("AXIV-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("AXIV-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("AXIV-core", "Transaction too large"),
QT_TRANSLATE_NOOP("AXIV-core", "Transmitting final transaction."),
QT_TRANSLATE_NOOP("AXIV-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("AXIV-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("AXIV-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("AXIV-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("AXIV-core", "Upgrade wallet to latest format"),
QT_TRANSLATE_NOOP("AXIV-core", "Use OpenSSL (https) for JSON-RPC connections"),
QT_TRANSLATE_NOOP("AXIV-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Use UPnP to map the listening port (default: 1 when listening)"),
QT_TRANSLATE_NOOP("AXIV-core", "Use a custom max chain reorganization depth (default: %u)"),
QT_TRANSLATE_NOOP("AXIV-core", "Use the test network"),
QT_TRANSLATE_NOOP("AXIV-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("AXIV-core", "Value more than Obfuscation pool maximum allows."),
QT_TRANSLATE_NOOP("AXIV-core", "Verifying blocks..."),
...
QT_TRANSLATE_NOOP("AXIV-core", "Warning: This version is obsolete, upgrade required!"),
QT_TRANSLATE_NOOP("AXIV-core", "Warning: Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("AXIV-core", "Warning: Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("AXIV-core", "Will retry..."),
QT_TRANSLATE_NOOP("AXIV-core", "You need to rebuild the database using -reindex to change -txindex"),
QT_TRANSLATE_NOOP("AXIV-core", "Your entries added successfully."),
