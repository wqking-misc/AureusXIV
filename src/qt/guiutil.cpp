...
{
    // Convert vitae:// to vitae:
    //
    //    Cannot handle this later, because vitae:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open vitae.conf with the associated application */
...
{
    return GetAutostartDir() / "vitae.desktop";
}
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the vitae app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add vitae app to startup item list
