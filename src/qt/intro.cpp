...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AureusXIV Core"),
     ...
     * override -datadir in the aureusxiv.conf file in the default data directory
     * (to be consistent with aureusxivd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
