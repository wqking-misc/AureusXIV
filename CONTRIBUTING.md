Contributing to AureusXIV Core
============================

The AureusXIV Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AureusXIV Core project, and is not to be
confused with overall AureusXIV Network Protocol consensus changes.

Whether a pull request is merged into AureusXIV Core rests with the project merge
...
Patches that change AureusXIV consensus rules are considerably more involved than
...
Where a patch set proposes to change the AureusXIV consensus, it must have been
...
The project leader is the release manager for each AureusXIV Core release.
