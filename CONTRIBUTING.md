Contributing to AXIV Core
============================

The AXIV Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AXIV Core project, and is not to be
confused with overall AXIV Network Protocol consensus changes.

Whether a pull request is merged into AXIV Core rests with the project merge
...
Patches that change AXIV consensus rules are considerably more involved than
...
Where a patch set proposes to change the AXIV consensus, it must have been
...
The project leader is the release manager for each AXIV Core release.
